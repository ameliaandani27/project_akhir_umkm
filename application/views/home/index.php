...
<html lang="en">
  <head>
    ...
    <title>Web Elen</title>
    <!-- plugins:css -->
    <link rel="stylesheet" href="<?php echo base_url('asset/vendors/iconfonts/mdi/css/materialdesignicons.min.css')?>">
    <link rel="stylesheet" href="<?php echo base_url('asset/vendors/iconfonts/ionicons/dist/css/ionicons.css')?>">
  ...
  <body>
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auto-form-wrapper">
                <form action="#">
                  ...
                  <div class="form-group">
                   <a class="btn btn-primary submit-btn btn-block" href="<?php echo base_url("index.php/login/index")?>">Login</a> 
                    </button>
                  </div>
                  ...
                  <div class="form-group">
                    <button class="btn btn-block g-login">
                      <img class="mr-3" src="<?php echo base_url('asset/images/file-icons/icon-google.svg')?>" alt="">Log in with Google</button>
                  </div>
    ...
    <!-- endinject -->
    <script src="<?php echo base_url('asset/js/shared/jquery.cookie.js')?>" type="text/javascript"></script>
  </body>
</html>